...
transformed_data_path = storage_path + f"data/mastodon/ts_transformed/%s/{impute_methodology}_{impute_func}/S%s/merged_chunks_reg={registration_method},local_den=False,win size={window_size}.pkl"
