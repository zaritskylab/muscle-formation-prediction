...
class DataPreprocessStrategy(object):
    '''
...
class ActinIntensityDataPreprocess(DataPreprocessStrategy, ABC):
    '''
    ...
    def __init__(self):
        ...
        super(ActinIntensityDataPreprocess, self).__init__(name)
...
class MotilityDataPreprocess(DataPreprocessStrategy, ABC):
    '''
    An ordinary least squares (OLS) linear regression model
    '''
    ...
    def __init__(self):
        name = 'motility'
        super(MotilityDataPreprocess, self).__init__(name)
...
class NucleiIntensityDataPreprocess(DataPreprocessStrategy, ABC):
    '''
    An ordinary least squares (OLS) linear regression model
    '''
    ...
    def __init__(self):
        ...
        super(NucleiIntensityDataPreprocess, self).__init__(name)
