...
#
# def extract_distinct_features(df, feature_list):
#     df = extract_features(df, column_id='Spot track ID', column_sort="Spot frame", n_jobs=1, show_warnings=False)
#     impute(df)
#     return df[feature_list]
#
#
...
if __name__ == '__main__':
    ...
    dir_name = f"16-02-2022-manual_mastodon_motility-{motility}_intensity-{visual}"
